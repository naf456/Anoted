...
public class TitlesListAdapter extends BaseAdapter {
    ...
    TitlesListAdapter(Context context, List<String> documentTitles, Callbacks callback) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = lf.inflate(com.ream.app.R.layout.document_list_item, parent, false);
        }

        TextView titleEditText = (TextView)convertView.findViewById(com.ream.app.R.id.document_list_item_title_text);
        ImageButton removeButton = (ImageButton)convertView.findViewById(com.ream.app.R.id.document_list_item_remove_btn);
        ...
        if(mEditMode) {
            ...
            params.addRule(RelativeLayout.RIGHT_OF, com.ream.app.R.id.document_list_item_remove_btn);
            params.addRule(RelativeLayout.END_OF, com.ream.app.R.id.document_list_item_remove_btn);
