...
public class DocumentSelectDrawer extends Fragment implements TitlesListAdapter.Callbacks {
    ...
    public void setUp(int fragmentId, DrawerLayout drawerLayout, List<String> documentTitles) {
        ...
        this.mDrawerLayout.setDrawerShadow(com.ream.app.R.drawable.drawer_shadow, GravityCompat.START);
        ...
        mDrawerToggle = new ActionBarDrawerToggle(
                ...
                com.ream.app.R.string.navigation_drawer_open,  /* "open drawer" description for accessibility */
                com.ream.app.R.string.navigation_drawer_close  /* "close drawer" description for accessibility */
        ) {
            @Override
        ...
        mTitlesList.setAdapter(new TitlesListAdapter(getActionBar().getThemedContext(),
                mDocumentTitles,
                this));
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTitlesList = (ListView) inflater.inflate(
                com.ream.app.R.layout.fragment_document_drawer, container, false);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (mDrawerLayout != null && isDrawerOpen()) {
            inflater.inflate(com.ream.app.R.menu.global, menu);
            getActionBar().setTitle(com.ream.app.R.string.actionbar_global_title);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == com.ream.app.R.id.action_new_document && mCallbacks != null) {
            mCallbacks.onNavigationDrawerNewDocument();
            return true;
        }

        if (item.getItemId() == com.ream.app.R.id.action_edit_mode) {
