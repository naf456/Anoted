...
public class TitleEditorDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity())
            .setTitle(com.ream.app.R.string.dialog_title_change_document_title)
            .setView(editText)
            .setPositiveButton(com.ream.app.R.string.abc_action_mode_done, new DialogInterface.OnClickListener() {
                @Override
